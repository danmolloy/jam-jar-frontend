...
export const words = ["intonation", "rhythm", "pulse", "tuning", "phrasing", "tone", "dynamics", "contact", "listen", "piano", "excerpts", "concerto", "control", "singing", "dolce", "technical", "scales", "fingering", "bowing", "breathe", "centering", "memory", "mock", "recital"]
