...
export default function Hero() {
  return (
    <div className="h-screen w-screen bg-fuchsia-300 flex flex-col items-center pt-[30vh] -mt-12">
      ...
      <p className="font-bold my-2 lg:my-0 text-center lg:text-left">Jam Jar helps musicians stay consistent with structured practice tracking, recordings and insights.</p>
