...
export default function Hero() {
  return (
    <div className="h-screen w-screen bg-blue-400 text-dark flex flex-col items-center pt-[30vh] -mt-12">
      <h1 className="text-6xl lg:text-8xl font-display flex flex-col text-center">Jam Jar <span className="text-lg font-display">Practice diary for musicians</span></h1>
