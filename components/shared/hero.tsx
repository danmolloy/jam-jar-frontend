      ...
      <div className="flex lg:flex-row flex-col items-center justify-center  w-1/2 lg:w-1/3">
        ...
        <div className="  flex flex-col items-center justify-center">
          ...
          <div className="flex flex-row mt-2">
            <Link
              href={'/register'}
              className="bg-yellow-400 text-black border-fuchsia-800 border text-center rounded flex flex-row items-center justify-center font-bold  w-32 py-1 px-2  mx-2  hover:underline"
            >
              <p>Start for free</p>
            ...
            <a
              href={'/#about'}
              className="border-fuchsia-800  text-text-black  text-center rounded flex flex-row items-center justify-center font-bold border w-32 py-1 px-2  mx-2  hover:underline"
            >
              <p>Learn more</p>
              {/* <IoIosArrowRoundForward size={20}/> */}
            </a>
